      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-1 p-2">
          <button
            ...
            className="bg-blue-600 mb-3 text-white w-full cursor-pointer rounded-lg flex items-center justify-center gap-3 font-medium text-sm py-2 disabled:opacity-50"
